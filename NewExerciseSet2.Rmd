---
title: 'Exercise Set 2 Solutions: A $300 Billion Strategy'
...
We need 6 components to explain a little more than 50% of the variance of the data 
<br>
Higest values are for 5 yr T notes US (0.93) & 10 yr T Notes (0.93) and Treasury Bonds (0.86). 
<br>
1st component is T notes, bonds of different countries. 2nd component is for currencies like euros, pounds, swiss francs, Krones. etc. 3rd component is future contracts which track large cap european stock indices like FTSE 100 UK, CAC 40 France, Eurostoxx etc. 4th component is future ocntracts which track small cap American stock indices like SP500 E-Mini, Dow Jones & Nasdaq 100 mini. 5th component is European fixed income futures. 6th one is oil. 7th is metals. 8th is agriculture products. 9th is precious metals and 10th is asian stock indices.
<br>
```{r echo=TRUE, tidy=TRUE}
...
```
<br>
During  bear years (crisis time) the assets are more correlated when compared to during bull years. Hence, a fewer number of components can be used to describe the returns of the different futures. 
<br>
...
This uses a moving average to store the returns of the future as +ve or -ve. The strategy of investing in the future is based on these signs. 
<br>
This changes the investment strategy & what the portfolio is composed of. 
